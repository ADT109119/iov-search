...
onMounted(async ()=>{
    ...
    .then(() => {
        ...
        document.querySelector("#searchButton").addEventListener('click', ()=>{
            ...
            let message = `IOV:${temp.workTime.join('%2C')}\t${temp.workTimeDetail[0]}\t${temp.workTimeDetail[1]}\t${temp.workFeature.join('%2C')}\t${temp.workMoney}\t${temp.moneyZone[0]}\t${temp.moneyZone[1]}\t${areas.join('%2c')}\t${inputText.value}`
